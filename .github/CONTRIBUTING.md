...
Thank you for your interest in raising an issue with Stripe Payment. An issue can be either a bug report or a feature request.

By reporting bugs, you contribute directly to improving Stripe Payment. Bug reports help developers identify and fix issues quickly before they affect more users.
...
2. **Version number:**
   Include the Frappe, ERPNext, and stripe_payment versions you are using. The issue may already be fixed in a newer release.

3. **Clear title:**
   Use a descriptive title (e.g., "Payment Request stays queued after Stripe checkout completes" instead of "Payment not working").
