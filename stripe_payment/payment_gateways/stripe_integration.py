...
#
# Legacy Stripe subscription creation — extracted from monorepo payments
# `payment_gateways/stripe_integration.py`. Registered via
# `gateway_subscription_handler` for payment_core's dispatcher.
