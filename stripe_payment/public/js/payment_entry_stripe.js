// Adds a "Refund via Stripe" action to submitted Payment Entries that
// originated from a Stripe charge (i.e. carry a Stripe Payment Intent).
			...
			frm.add_custom_button(__("Refund via Stripe"), () => {
				const d = new frappe.ui.Dialog({
					...
					primary_action(values) {
						d.hide();
						frappe.call({
							method: "stripe_payment.stripe.doctype.stripe_settings.stripe_settings.refund_payment_entry",
							args: {
